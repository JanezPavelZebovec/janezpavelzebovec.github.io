...
main(int argc, char **argv) {
    ...
    /* Zabelezi dogodek zaklepanja */
    if (fork() == 0) {
        execl("/home/janezpavel/.local/bin/raba",
              "raba",
              "lock",
              (char*)NULL);
    }
    /*system("/home/janezpavel/.local/bin/raba lock");*/
    ...
    /*system("/home/janezpavel/.local/bin/raba unlock");*/
